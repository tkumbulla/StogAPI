...
{
    /// <summary>
    /// Defining settings for authentication
    /// </summary>
    public class AuthenticationSettings
    {
        ...
        /// </summary>
        public static string ClaimsIssuer { get; set; } = "STOG";
        ...
        /// </summary>
        public static string ExternalAuthenticationErrorsSessionKey { get; set; } = "stog.externalauth.errors";

        /// <summary>
        /// Gets the cookie name prefix
        /// </summary>
        public static string CookiePrefix { get; set; } = ".STOG";
