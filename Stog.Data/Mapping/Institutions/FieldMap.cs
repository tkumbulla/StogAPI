...
{
    /// <summary>
    /// Mappings for the Field entity.
    /// </summary>
    public class FieldMap : BaseEntityTypeConfiguration<Field>
    {
        /// <summary>
        /// configure mappings
        /// </summary>
        ...
        /// </summary>
        /// <param name="builder"></param>
        protected override void PostConfigure(EntityTypeBuilder<Field> builder)
        {
